...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to pretrained VAE model or VAE model identifier from huggingface.co/models.",
    )
    parser.add_argument(
        "--revision",
        type=str,
    ...
    parser.add_argument('--num_instance_images', type=int, default=None,
                        help='Number of instance images to use; if not specified, all images will be used')
    parser.add_argument(
        "--output_dir",
        type=str,
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        if num_instance_images is not None:
            self.instance_images_path = self.instance_images_path[:num_instance_images]
...
def main(args):
    ...
    if args.pretrained_vae_name_or_path is not None:
        vae_pretrain_id = args.pretrained_vae_name_or_path
        vae = AutoencoderKL.from_pretrained(vae_pretrain_id)
    else:
        vae_pretrain_id = args.pretrained_model_name_or_path
    ...
    train_dataset = DreamBoothDataset(
        ...
        num_instance_images=args.num_instance_images
    )
